...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5762767041596330968L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"com.example\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.Greeting.Builder newBuilder() {
    return new com.example.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.example.Greeting.Builder newBuilder(com.example.Greeting.Builder other) {
    if (other == null) {
      return new com.example.Greeting.Builder();
    } else {
      return new com.example.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static com.example.Greeting.Builder newBuilder(com.example.Greeting other) {
    if (other == null) {
      return new com.example.Greeting.Builder();
    } else {
      return new com.example.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.Greeting other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Greeting.Builder clearGreeting() {
      greeting = null;
